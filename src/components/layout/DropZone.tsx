  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-radial bg-grid relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl animate-fade-in-up">
        ...
        {/* Supported formats */}
        <div className="mt-8 flex items-center justify-center gap-6 text-text-muted text-xs">
...
function IdleState({ isDragOver }: { isDragOver: boolean }) {
  return (
    <div className="space-y-4">
      <div className={`mx-auto w-16 h-16 rounded-2xl flex items-center justify-center transition-all ${isDragOver ? 'bg-accent-blue/20 scale-110' : 'bg-surface'}`}>
        <svg
...
function LoadingState({ progress }: { progress: number }) {
  return (
    <div className="space-y-4">
      <div className="mx-auto w-16 h-16 rounded-2xl bg-accent-blue/10 flex items-center justify-center">
